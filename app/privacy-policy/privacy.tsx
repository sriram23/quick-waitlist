  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><strong>Temporary Session Time:</strong> Data stored in &apos;sessionStorage&apos; is automatically cleared when you close the corresponding browser tab.</li>
